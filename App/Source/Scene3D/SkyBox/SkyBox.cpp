...
bool CSkyBox::Init(void)
{
	...
	skyboxTexture.push_back("Image/SkyBox/RightShaq.jpg");
	skyboxTexture.push_back("Image/SkyBox/LeftShaq.jpg");
	skyboxTexture.push_back("Image/SkyBox/TopShaq.jpg");
	skyboxTexture.push_back("Image/SkyBox/BottomShaq.jpg");
	skyboxTexture.push_back("Image/SkyBox/FrontShaq.jpg");
	skyboxTexture.push_back("Image/SkyBox/BackShaq.jpg");
